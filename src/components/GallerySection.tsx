...
const galleryImages = [
  ...
  {
    id: 3,
    url: "https://images.unsplash.com/photo-1545205528-3dc1ae75f21c?q=80&w=1470",
    title: "Групповые занятия танцами",
    category: "activities",
  },
  {
    id: 4,
  ...
  {
    id: 5,
    url: "https://images.unsplash.com/photo-1629138144297-d3f09f9a2c75?q=80&w=1474",
    title: "Зона отдыха",
    category: "spaces",
  },
  {
    ...
    const handleScroll = () => {
      ...
      parallaxElements.forEach((element, index) => {
        ...
        if (
          ...
          elementPosition > -element.clientHeight
        ) {
          const offset = (elementPosition - windowHeight) * 0.1;
          const direction = index % 2 === 0 ? 1 : -1;
          element.setAttribute(
            "style",
            `--parallax-offset: ${offset * direction}px`,
          );
        }
      });
    };
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Погрузитесь в атмосферу нашего фитнес-клуба Баланс. Современные
            тренажеры, комфортные зоны и профессиональные инструкоры ждут вас.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredImages.map((image, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent flex flex-col justify-end p-4 transition-opacity duration-300 ${hoveredImage === image.id ? "opacity-100" : "opacity-90"}`}
              >
