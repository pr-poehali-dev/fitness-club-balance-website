...
const features = [
  {
    ...
    description:
      "Оборудование мирового класса для эффективных тренировок любого уровня сложности.",
  },
  {
    id: 2,
    icon: "Users",
  ...
  },
  {
    ...
    description:
      "Индивидуальный подход с учетом ваших целей, возможностей и особенностей здоровья.",
  },
  {
    id: 4,
    icon: "HeartPulse",
    title: "Кардиозона",
    description:
      "Беговые дорожки, эллиптические тренажеры и велотренажеры для эффективных кардиотренировок.",
  },
  {
    id: 5,
    icon: "Droplets",
  ...
  },
  {
    ...
    description:
      "Консультации по питанию и богатый выбор спортивного питания для достижения ваших целей.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Мы предлагаем широкий спектр услуг, чтобы каждый мог найти
            подходящую для себя тренировку и достичь своих фитнес-целей.
          </p>
        </div>
        ...
        <div className="mt-16 text-center bg-primary/10 rounded-xl p-8 relative">
          ...
          <p className="mb-6 max-w-3xl mx-auto">
            ...
            подобрать оптимальную программу тренировок. Оставьте заявку, и мы
