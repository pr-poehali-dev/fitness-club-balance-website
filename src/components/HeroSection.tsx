  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1593079831268-3381b0db4a77?q=80&w=2069')",
      ...
      <div className="absolute inset-0 opacity-20 bg-accent">
        ...
        <div
          className="absolute left-20 top-[40%] w-24 h-24 mask-diamond bg-secondary animate-pulse-slow"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute right-32 bottom-[15%] w-36 h-36 mask-diamond bg-primary animate-pulse-slow"
      ...
      >
        {/* Mascot */}
        <div
          className="absolute -right-10 md:right-0 top-0 md:top-10 w-32 md:w-40 lg:w-48 animate-bounce"
        ...
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
            Фитнес-клуб <span className="text-primary">Баланс</span> – для
            идеального баланса тела и духа
          </h1>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Современное оборудование, профессиональные тренеры и персональный
            подход. Начните свой путь к здоровью уже сегодня!
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center gap-4">
            ...
            <Button
              variant="outline"
              className="bg-white/10 text-white border-white/30 hover:bg-white/20 py-6 px-8 text-lg backdrop-blur-sm"
            >
