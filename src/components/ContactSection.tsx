        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground mb-8">
              У вас остались вопросы или вы хотите записаться на пробную тренировку?
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">info@balance-fitness.ru</p>
                </div>
              </div>
            </div>
            
            <div className="mt-8">
              <h3 className="font-semibold text-lg mb-3">Мы в социальных сетях</h3>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="mt-6 flex items-center justify-center p-4 bg-primary/5 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Балансик и вся команда фитнес-клуба с нетерпением ждут встречи с вами!
                  </p>
                </div>
              </CardContent>
            </Card>
